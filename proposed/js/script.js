...
sqlfiddle.prototype.setType = function(){
	return this.db.type;
}
sqlfiddle.prototype.getType = function(type){
	this.db.type = type;
}
sqlfiddle.prototype.run = function(){
	...
	// 	}
	// });
	var TestResult = {"SUCCEEDED":true,"short_code":"a2581","sql":"select id, type, details from supportContacts\nUNION\nselect 3, 'Consulting', 'http:\/\/www.geonorth.com'\n","RESULTS":{"COLUMNS":["ID","TYPE","DETAILS"],"DATA":[[142,"Email","admin@sqlfiddle.com"],[143,"Twitter","@sqlfiddle"],[3,"Consulting","http:\/\/www.geonorth.com"]]},"db_type_id":"2","EXECUTIONTIME":0,"ddl":"CREATE TABLE supportContacts \n\t(\n     id int auto_increment primary key, \n     type varchar(20), \n     details varchar(30)\n    );\n\nINSERT INTO supportContacts\n(type, details)\nVALUES\n('Email', 'admin@sqlfiddle.com'),\n('Twitter', '@sqlfiddle');"};
	this.buildResultsTable(TestResult);
}
